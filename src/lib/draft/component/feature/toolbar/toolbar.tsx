...
import useGetBounding from "../../../../../hooks/useGetBounding";
  ...
  const axis = useMemo(() => {
    ...
    const currentSelectedDOM =
      currentSelectionRangeCount && currentSelectionRangeCount > 0
        ...
        : null;
    const currentSelectedDOMBoundingRect =
      currentSelectedDOM?.getBoundingClientRect();
    ...
    <div ref={ref} className={classNames(style["colorPicker"])}>
      ...
      <div
        className={classNames(
          ...
          isOpen && style["fadeInContainer__active"]
        )}
        ref={pickerRef}
        style={{ ...position }}
      >
  ...
  return (
    <div ref={ref}>
      ...
      >
        <Flexbox
          direction={"col"}
          className={classNames(style["textAlignmentPicker__container"])}
        >
